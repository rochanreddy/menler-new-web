        ...
        <div className="lp2-main">
          ...
          <section className="lp2-community-wrap">
            ...
            <div className="lp2-community lp2-community--row">
              <p className="lp2-comm-sub">{d.communityText}</p>
              <div className="lp2-comm-grid">
              <a className="lp2-comm-card lp2-comm-card--discord" href={d.discordUrl || '#'} target="_blank" rel="noopener noreferrer" aria-label="Join our Discord">
              ...
              <a className="lp2-comm-card lp2-comm-card--whatsapp" href={d.whatsappUrl || '#'} target="_blank" rel="noopener noreferrer" aria-label="Join our WhatsApp community">
              ...
              <a className="lp2-comm-card lp2-comm-card--facebook" href={d.facebookUrl || '#'} target="_blank" rel="noopener noreferrer" aria-label="Join us on Facebook">
