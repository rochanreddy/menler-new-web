  ...
  return (
    <>
      ...
      <section className="section" style={{ background: 'var(--parchment)' }}>
        ...
        <h2 className="section-h2">Why we built<br /><em>Meridian.</em></h2>
        <div className="about-grid">
          ...
          <div className="about-card" style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <div style={{ background: 'var(--cloud)', borderRadius: 10, padding: '18px 20px' }}>
              ...
              <p style={{ fontSize: 14, color: 'var(--ink)', lineHeight: 1.6 }}>Every Meridian program is built backwards from a real job outcome. What does a placed Generalist do on day one at work? What does a Claude Engineer ship in their first sprint? We design backward from the answer.</p>
            </div>
      ...
      <section className="section" style={{ background: 'white' }}>
        ...
        <h2 className="section-h2">Six values that<br /><em>run Meridian.</em></h2>
      ...
      <section className="section" style={{ background: 'var(--parchment)' }}>
        ...
        <div className="team-note" style={{ maxWidth: 680, margin: '0 auto', background: 'white', borderRadius: 14, padding: '28px 32px', border: '0.5px solid rgba(175,169,236,0.2)' }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.7 }}>We'll be sharing the full Meridian team — instructors, mentors, curriculum designers, and placement leads — when Cohort 01 goes live. For now: every person involved in the program is actively using Claude in their professional work. No exceptions.</p>
        </div>
      </section>
      ...
      <section className="section" style={{ background: 'white' }}>
        ...
        <h2 className="section-h2">Three ways to<br /><em>work with Meridian.</em></h2>
        <div className="qualify-grid">
          <div className="qualify-card" style={{ cursor: 'pointer' }} onClick={() => go('/outcomes')}>
            ...
            <p className="qualify-desc">Access the Meridian hiring pipeline. Certified Claude Specialists across seven domain tracks — Finance, Marketing, VC, Operations, Technology, Engineering, and Founder's Office.</p>
            <p style={{ fontSize: 12, color: 'var(--specialist)', fontWeight: 500, marginTop: 8 }}>See outcomes →</p>
          </div>
          <div className="qualify-card">
            <p className="qualify-title">Meridian Teams <span style={{ fontSize: 11, fontWeight: 400, color: 'var(--text-muted)' }}>· B2B</span></p>
          ...
          <div className="qualify-card">
            <p className="qualify-title">Careers at Meridian</p>
