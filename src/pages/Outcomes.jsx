...
const PRODUCTS = [
  ...
  { group: 'generalist', tag: 'Generalist · VC', thumbCls: '', icon: 'Vc', name: 'Caldera Deal Flow Agent', desc: 'Cowork-driven agent that screens 200+ decks/month, drafts memos, and flags red-flags grounded in fund thesis.', meta: 'Built by Aman K. · Used at Caldera Ventures' },
