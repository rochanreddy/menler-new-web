    ...
    return (
      <div className="cox cox--confirm">
        <div className="cox-confirm">
          ...
          {/* WhatsApp community card — centered */}
          <div className="cox-community-card">
            <div className="cox-community-icon">
            ...
            <h3 className="cox-community-h">Join our Menler <em>community</em></h3>
            <p className="cox-community-sub">{reg.whatsappText || reg.communityText || 'Join our WhatsApp community for updates, resources & support.'}</p>
            <a
              className="cox-community-btn"
              href={reg.whatsappUrl || COMMUNITY_LINKS.whatsapp}
              target="_blank"
