...
export const PROGRAM_PRICES = {
  ...
  // NOTE: campaign slugs are absent on purpose — campaign registration is FREE,
  // and so are its playbooks now that the ₹99 pack is retired. Checkout totals
  // ₹0 for them and skips Cashfree entirely.
